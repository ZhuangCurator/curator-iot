...
import com.curator.iot.modbus.rtu.ModbusRtuClient;
 ...
 * @date 2025/2/27 
 */
public class ModbusRtuClientExample {

    private static final Logger logger = LoggerFactory.getLogger(ModbusRtuClientExample.class);
    ...
    public static void main(String[] args) {
        ...
        ModbusClient client = new ModbusRtuClient();
        try {
